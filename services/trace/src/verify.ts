/**
 * The standalone verifier (ARCHITECTURE.md).
 *
 ...
 *    that never settled.
 *
 * The claim this supports is the narrow one from ARCHITECTURE.md — every payment
...
export async function verifyTrace(
  ...
  for (const step of trace.steps) {
    ...
    // **The mandatory check** (ARCHITECTURE.md): the attested handle must equal
