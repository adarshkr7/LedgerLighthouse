 ...
 * against replacing the wait with a hardcoded sleep.
 *
 ...
 * is expected and harmless (ARCHITECTURE.md).
 */
 ...
 * for (ARCHITECTURE.md, the [INCO] liveness row).
 */
