 ...
 * rejection and retrying is the anti-pattern in brief §8 — the bounce is the
 ...
 * decision is unobtainable — a distinct, reportable state (plan §7.8). Merging
 ...
 * (M5) and the UI consume this; nothing in the loop formats a string for
